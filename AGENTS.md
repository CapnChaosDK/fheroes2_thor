...
- Latest hardware-validated source commit: `3f07965c6dc86c6a160e38fec09024331f5bde54`.
- Individual Hero Meeting artifact transfers and swaps, plus configurable consistent lower-deck haptics, are hardware-validated on 2026-09-07. Adventure and Editor System Options share a persistent, system-respecting haptics toggle; accepted lower-deck actions tick once when enabled, while cancellation and rejected/no-op interaction remain silent. Android build, app/isotools lint, native request regression tests, identifier parity, explicit Thor installation/launch, and all focused hardware checks passed. Development APK SHA-256: `F08438A8A94C2939BAA2D0FB01F30600E5E8DCFA27E51038BE31735C14970989`. This development checkpoint is newer than the published v0.10.0 release.
...
- The latest hardware-validated source implementation is `3f07965c6dc86c6a160e38fec09024331f5bde54`.
- Show Artifacts / Show Army, individual empty-slot moves and occupied-slot swaps, distinct scroll spells, spellbook protection, assembled sets, stats/scouting, cancellation, nested restoration, lifecycle, configurable system-respecting haptics, and all troop/whole-artifact/input regressions passed on the Thor. The validated APK remains at `android/app/build/outputs/apk/debug/app-debug.apk` when build outputs have not been cleaned. SHA-256: `F08438A8A94C2939BAA2D0FB01F30600E5E8DCFA27E51038BE31735C14970989`.
