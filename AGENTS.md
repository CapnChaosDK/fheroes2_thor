...
- This checkpoint integrates official upstream through `d778cb44b`, including the surrendered-hero empty-army repair and water-Hero Editor support. It also adds Thor-default-branch Android CI without development-push releases, full native/Java identifier parity, and compile-time rejection of same-context action-mask collisions. Android build, app and isotools lint, explicit Thor installation and launch, and the focused six-check hardware run passed. The debug APK SHA-256 is `2EDE3EBEE1240236D9D167CA5DB286A52554B07F5C38704215CD286F079CA05A`.
...
- The latest hardware-validated source implementation is `151f62abd`.
- Build and lint passed, the candidate installed and launched explicitly on the Thor, and upstream integration, precise splitting, surrender retention, water-Hero Editor behavior, restoration, haptics, dual-screen, upper-touchscreen, and physical-controller regressions passed. The validated debug APK remains at `android/app/build/outputs/apk/debug/app-debug.apk` when build outputs have not been cleaned. SHA-256: `2EDE3EBEE1240236D9D167CA5DB286A52554B07F5C38704215CD286F079CA05A`.
