...
The latest hardware-validated source checkpoint is `3f07965c6dc86c6a160e38fec09024331f5bde54`. It adds configurable, consistent lower-deck haptics to every validated individual-artifact workflow: Adventure and Editor System Options share a persistent `HAPTICS: ON/OFF` control, and ON gives one system-respecting tick for accepted lower-deck commands and valid map, troop, and artifact transitions. Cancels, no-ops, rejected requests, navigation, and non-lower-screen input remain silent. Android build and app/isotools lint passed; the user passed focused Thor validation. The development APK SHA-256 is `F08438A8A94C2939BAA2D0FB01F30600E5E8DCFA27E51038BE31735C14970989`. The latest published release remains [`thor-v0.10.0`](https://github.com/CapnChaosDK/fheroes2_thor/releases/tag/thor-v0.10.0), built from `9a7c595f2`; this newer development checkpoint is not a new release. See [the backlog](AYN_THOR_BACKLOG.md) for validation history and deferred work.

The current development checkpoint is hardware-validated. Upstream repairs, precise splitting, artifact transfers, complete Options and nested settings, lifecycle recovery, configurable system-respecting haptics, dual-screen presentation, upper touchscreen, mouse, and physical controls passed together. The recommended next focused slice is player-installed artifact artwork; select and approve its exact behavior and tests before implementation.
