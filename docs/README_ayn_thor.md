...
The latest hardware-validated source checkpoint is `151f62abd`. It integrates official upstream through `d778cb44b`, including the surrendered-hero empty-army repair and water-Hero Editor support, and adds Thor-default-branch Android CI without development-push releases, complete native/Java identifier parity, and compile-time same-context action-mask collision protection. It retains precise Hero Meeting stack splitting, direct manipulation, tap and whole-army transfers, player-installed Hero and creature visuals, complete in-game Adventure and File Options, semantic gameplay dialogs, the safe unknown-menu fallback, the complete Expanded Adventure Map, information cards, navigable menus, both campaign selectors, the complete Editor workflow, touch-minimap viewport control, and Hero and Castle quick-selection lists. Its APK SHA-256 is `2EDE3EBEE1240236D9D167CA5DB286A52554B07F5C38704215CD286F079CA05A`. [`thor-v0.9.0`](https://github.com/CapnChaosDK/fheroes2_thor/releases/tag/thor-v0.9.0) remains the latest published release.

The current development checkpoint is hardware-validated. Upstream surrender retention and water-Hero Editor behavior, exact Hero Meeting splitting, lifecycle recovery, context restoration, haptics, dual-screen presentation, upper touchscreen, and physical controls passed together. Select and approve the next focused slice before further implementation.
