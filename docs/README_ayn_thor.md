...
The latest hardware-validated source checkpoint is `9a7c595f2`. It integrates official upstream through `d778cb44b`, including the surrendered-hero empty-army repair and water-Hero Editor support, and adds precise Hero Meeting stack splitting, whole-artifact transfers and swapping, semantic necromancy control, complete Adventure Map Options, and dedicated nested Graphics, Audio, Interface, Language, Hot Keys, and Resolution decks. It also includes Thor-default-branch Android CI without development-push releases, complete native/Java identifier parity, and compile-time same-context action-mask collision protection. It retains direct troop manipulation, tap and whole-army transfers, player-installed Hero and creature visuals, semantic gameplay dialogs, the safe unknown-menu fallback, the complete Expanded Adventure Map, information cards, navigable menus, both campaign selectors, the complete Editor workflow, touch-minimap viewport control, and Hero and Castle quick-selection lists. Its APK SHA-256 is `E3DC75FF2B8A512E05BA36BBBCCE75B993E14A30540D2ECBFBD4D2DFA35441F6`. [`thor-v0.10.0`](https://github.com/CapnChaosDK/fheroes2_thor/releases/tag/thor-v0.10.0) is the latest published prerelease.
